...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes, you can use Avatartion to create Notion-style avatars for your personal and commercial projects. There are no restrictions on how you can use the avatars you create.",
  },
  {
    question: "Is Avatartion affiliated with Notion?",
    answer:
      "No, Avatartion is not affiliated with Notion.",
  },
];
export const FAQs = () => {
  return (
